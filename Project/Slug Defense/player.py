...
class IdleState:
    ...
    def draw(player):
        if player.check_cannon == False:
            ...
            player.image.clip_draw(player.frame * 140, 0, 140, 80, player.x + 40, player.y)
...
class DriveState:
    ...
    def do(player):
        if player.check_cannon:
            player.frame = (player.frame + 1) % 23
        else:
    ...
    def draw(player):
        if player.check_cannon == False:
            ...
            player.image.clip_draw(player.frame * 140, 0, 140, 80, player.x, player.y)
