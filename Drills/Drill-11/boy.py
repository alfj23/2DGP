...
next_state_table = {
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState,
                ...
                SLEEP_TIMER: SleepState, SPACE: IdleState}, #스페이스가 눌리면 다시 아이들 스테이트로
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState,
               LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SPACE: RunState}, # 스페이스 눌리면 다시 런 스테이트로
    SleepState: {LEFT_DOWN: RunState, LEFT_UP: RunState,
                 RIGHT_DOWN: RunState, RIGHT_UP: RunState,
                 SPACE: IdleState}
}
